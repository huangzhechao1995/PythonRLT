...
cdef extern from "Rectangle.h" namespace "shapes":
  cdef cppclass Rectangle:
        ...
        vector[vector[double]] multiply_mat(vector[vector[double]]&, vector[vector[double]]&)
...
cdef class PyRectangle:
    ...
    def multiply_mat(self, vec_a, vec_b):
        return self.thisptr.multiply_mat(vec_a, vec_b)