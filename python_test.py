...
#Test8: Returning a 2D numpy array from c++
list7a = np.array([[1, 2, 3], [4, 5, 6]])
list7b = np.array([[1, 1], [4, 5], [-1, -1]])
print("Test 8, matrix multiplication result: ", R1.multiply_mat(list7a, list7b))
